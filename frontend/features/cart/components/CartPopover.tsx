...
export const CartPopover = () => {
    ...
    return (
        <Popover open={open} onOpenChange={setOpen}>
            ...
            <PopoverContent className="flex w-screen h-screen mt-7 p-0 border-none rounded-none z-100 bg-black/80">
                <div className="ml-auto p-0 border-none rounded-none bg-[#D9D9D9]/95 w-full h-full md:w-[30vw] flex flex-col gap-4 justify-start items-start">
                    ...
                    <CartList />
                    <CartPopoverSummary onViewCart={() => setOpen(false)} />
                </div>
            </PopoverContent>
        </Popover>
    )
