    ...
    return (
        <Popover>
            ...
            <PopoverContent className="mt-4">
                <Link href="/collection" className="block m-0.5 p-1 hover:bg-white/10 border-transparent rounded-lg">Collections</Link>
                <Link href="/viewAll" className="block m-0.5 p-1 hover:bg-white/10 border-transparent rounded-lg">View All</Link>
