...
export interface ApiCollectionCollection extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    collectionImage: Schema.Attribute.Media<'images'>;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'collectionName'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiFaqArticleFaqArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    content: Schema.Attribute.DynamicZone<
      ['shared.text-block', 'shared.first-paragraph', 'shared.button']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    excerpt: Schema.Attribute.Text;
    faqItems: Schema.Attribute.Relation<'manyToOne', 'api::faq-item.faq-item'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiFaqItemFaqItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    faqArticles: Schema.Attribute.Relation<
      'oneToMany',
      'api::faq-article.faq-article'
    >;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::order.order'> &
      Schema.Attribute.Private;
    orderStatus: Schema.Attribute.Enumeration<['pending', 'paid', 'cancelled']>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    collectionItem: Schema.Attribute.Relation<
      'oneToOne',
      'api::collection.collection'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiStoreStore extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    openingHours1: Schema.Attribute.String;
    openingHours2: Schema.Attribute.String;
    openingHours3: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    storeImage: Schema.Attribute.Media<
